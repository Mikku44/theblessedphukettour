...
const BookingForm = () => {
  ...
  return (
    <div className="p-6 grid gap-4 lg:w-[50vw] md:w-[70vw] w-full mx-auto">
      <h2 className="text-xl font-bold mb-4 ">Boat Booking Form</h2>
      ...
      <div className="mt-4 grid gap-4">
        ...
        <select
          name="programSet"
          value={formData.programSet}
          //   onChange={handleChange}
          className=" p-2 border rounded-md"
        >
          <option value="p1">Program 1 (Cost : $850)</option>
          <option value="p2">Program 2 (Cost : $800)</option>
        </select>
      </div>
      ...
      <label htmlFor="placePickup" className="block text-sm font-medium text-gray-700">Place of picking up</label>
      <input
        id="placePickup"
        name="placePickup"
        type="placePickup"
        autoComplete="placePickup"
