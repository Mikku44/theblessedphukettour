...
const BookingForm = () => {
  ...
  return (
    <div className="p-6 grid gap-4 lg:w-[50vw] md:w-[70vw] w-full mx-auto">
      <h2 className="text-xl font-bold mb-4 ">Tour Booking Form</h2>
      ...
      {formData.transService == "Pick up" &&
        <>
          <label htmlFor="pickupPlace" className="block text-sm font-medium text-gray-700">Place of picking up</label>
          <input
            id="pickupPlace"
            name="pickupPlace"
            type="text"
            autoComplete="pickupPlace"
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="ml-4 flex items-center">
          <Button className="bg-[--primary]" onClick={() => handleDecrement(setNumAdults)}>-</Button>
          <input className="mx-2 border border-gray-400 rounded-md w-[40px] h-[40px] text-center py-2" value={numAdults}></input>
          <Button className="bg-[--primary]" onClick={() => handleIncrement(setNumAdults)}>+</Button>
        </div>
      </div>
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="ml-4 flex items-center">
          <Button className="bg-[--primary]" onClick={() => handleDecrement(setNumChildren)}>-</Button>
          <input className="mx-2 border border-gray-400 rounded-md w-[40px] h-[40px] text-center py-2" value={numChildren}></input>
          <Button className="bg-[--primary]" onClick={() => handleIncrement(setNumChildren)}>+</Button>
        </div>
      </div>
