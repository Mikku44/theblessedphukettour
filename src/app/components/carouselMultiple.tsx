...
const Carousel = ({ images }) => {
  ...
  return (
    <div className="flex flex-col gap-2 justify-center lg:mx-2">
      ...
      {images && <div className="lg:flex flex-col gap-2 md:flex hidden">
        {images?.map((imageURL, index) => <div onClick={() => handleDotClick(index)} key={index} className=" bg-black aspect-square w-[100px] overflow-hidden">
